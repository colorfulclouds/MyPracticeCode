...
public class explorer extends JFrame {
	...
	public explorer() {
		super("Internet Explorer"); // 调用父类构造函数

		jtfAddress = new JTextField(20); // 实例化地址输入框
		jbGo = new JButton("確定"); // 实例化转向按钮
		jtpShow = new JTextPane(); // 实例化显示内容框
		jtpShow.setBackground(new Color(52, 132, 242));
		jlInfo = new JLabel(); // 实例化信息提示标签//左下角狀態欄信息
